...
@Composable
fun CloudAlbumCntScreen(
    mainNavController: NavController<ScreenDestination>,
    dialogNavController: NavController<DialogDestination>,
    paddingValues: PaddingValues,
    id: String,
    cloudAlbumCntViewModel: CloudAlbumCntViewModel = viewModel(factory = viewModelFactory {
        addInitializer(CloudAlbumCntViewModel::class) { CloudAlbumCntViewModel(id) }
    })
) {
    val albumInfo by cloudAlbumCntViewModel.albumInfo.observeAsState()
    Column {
        TopAppBar(
